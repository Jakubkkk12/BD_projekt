...
try:
    ...
    test_insert_query = """ CALL add_type_of_instrument(%s::VARCHAR); """

    # Dane do wstawienia
    dane = [
        (None,),  # Test 1: NULL
        ('A very long type of instrument',),  # Test 2: Przekroczenie 20 znaków
        ('Guitar',),  # Test 3: Typ instrumentu już istnieje
        ('Guitar',),  # Test 3: Typ instrumentu już istnieje
        ('Piano',),  # Test 4: Prawidłowy zapis
        ('Violin',),  # Test 5: Prawidłowy zapis
        ('Flute',),  # Test 6: Prawidłowy zapis
        ('Drums',),  # Test 7: Prawidłowy zapis
        ('Keyboard',)  # Test 8: Prawidłowy zapis
    ]
