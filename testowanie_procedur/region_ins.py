...
try:
    ...
    test_insert_query = """ CALL add_region(%s::VARCHAR,%s::SMALLINT); """
    ...
    dane = [
        ...
        ('Lombardia', 13),
        ('Malopolska',7,),
        ('Malopolskaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa', 7,),
    ]
